...
const ACCList = () => 
{
    ...
    const columns = [
        ...
        {
            name: 'status',
            selector: (row: any) => row.status_acc,
            sortable: true,
        },
        {
            name:"Action",
                            ...
                            <div className="card">
                                ...
                                <div className="card-body card-block">
                                    ...
                                    <form action="" method="post"  className="form-horizontal">
                                        ...
                                        <div className="col col-md-6"> 
                                                <div className="col col-md-3"><label htmlFor="phone" className=" form-control-label">Phone No.</label></div>
                                                <div className="col-12 col-md-9"><input type="text" id="phone" name="phone" placeholder="Enter Phone No." className="form-control" /><small className="help-block form-text">Please enter your phone no.</small></div>
                                            </div>
